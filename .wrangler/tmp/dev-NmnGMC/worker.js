(() => {
  ...
  // .wrangler/tmp/bundle-Qg6MhQ/checked-fetch.js
...
`
  ...
  // .wrangler/tmp/bundle-Qg6MhQ/strip-cf-connecting-ip-header.js
  ...
  // .wrangler/tmp/bundle-Qg6MhQ/middleware-insertion-facade.js
        ...
        try {
          ...
          const stream = new ReadableStream({
            async start(controller) {
              const processChunk = /* @__PURE__ */ __name(async () => {
                try {
